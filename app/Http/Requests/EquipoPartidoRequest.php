...
class EquipoPartidoRequest extends FormRequest
{
    ...
    {
        return [
            'golesFL' => ['required', 'numeric', 'max_digits:2'],  // Validar que 'golesFL' sea un número entero
            'golesFV' => ['required', 'numeric', 'max_digits:2'],  // Validar que 'golesFV' sea un número entero
