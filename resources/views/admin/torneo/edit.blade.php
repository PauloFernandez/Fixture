...
@section('content_body')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-8">
                <h2>{{ __('view.editar') . ' ' . __('view.torneo') }}</h2>
                <form method="POST" action="{{ route('admin.torneo.update', $torneo->id) }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="inscripcion" value="{{ $torneo->inscripcion }}"
                        ...
                        <label for="valor_cancha" class="col-sm-2 col-form-label">{{ __('view.costo') . ' ' .  __('view.cancha') }}</label>
                        <div class="col-sm-4">
                            <input type="text" name="valor_cancha" value="{{ $torneo->valor_cancha }}"
                    ...
                    <div class="row">
                        <p class="fs-2 text-center">Informacion del torneo</p>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="cant_equipos" value="{{ $torneo->cant_equipos }}"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="premios" value="{{ $torneo->premios }}"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="ubicacion" value="{{ $torneo->ubicacion }}"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="reglas_gral" rows="3" 
                                class="form-control @error('reglas_gral') is-invalid @enderror is-valid">{{ $torneo->reglas_gral }}</textarea>
                            @error('reglas_gral')
                                <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="sis_competicion" rows="3" 
                                class="form-control @error('sis_competicion') is-invalid @enderror is-valid">{{ $torneo->sis_competicion }}</textarea>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="elegibilidad" rows="3"
                                class="form-control @error('elegibilidad') is-invalid @enderror is-valid">{{ $torneo->elegibilidad }}</textarea>
                            @error('elegibilidad')
                                <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="disciplina" rows="3"
                                class="form-control @error('disciplina') is-invalid @enderror is-valid">{{ $torneo->disciplina }}</textarea>
                            @error('disciplina')
                                <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
                       ...
                       <!-- Campo oculto para asegurarse de que siempre se envíe un valor -->
                    <input type="hidden" name="publicado" value="0">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="1" name="publicado"
                            id="publicado" {{ old('publicado', $torneo->publicado ) == 1 ? 'checked' : '' }}>
