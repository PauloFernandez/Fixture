...
@section('content_body')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-8">
                <h2>{{ __('view.nuevo') . ' ' . __('view.noticias') }}</h2>
                <form method="POST" action="{{ route('admin.noticia.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="descripcion" id="descripcion" rows="3" {{ old('descripcion') }}
                                class="form-control @error('descripcion') is-invalid @enderror is-valid"></textarea>
                            @error('descripcion')
                                <span class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </span>
