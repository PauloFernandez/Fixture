...
@section('content_body')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-8">
                <h2>{{ __('view.nuevo') . ' ' . __('view.tarjeta') }}</h2>
                <form method="POST" action="{{ route('admin.tarjeta.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="multa" value="{{ old('multa') }}"
